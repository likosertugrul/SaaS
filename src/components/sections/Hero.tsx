    ...
    return (
        <section className="relative pt-32 lg:pt-36">
            <Container className="flex flex-col lg:flex-row gap-10 lg:gap-12">
                <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-8">

                    <span className="absolute -left-6 md:left-4 top-24 lg:top-28 w-24 h-24
                                     rotate-90 skew-x-12 rounded-3xl bg-gradient-to-r 
                                     from-blue-600 to-violet-600 blur-xl opacity-60 lg:opacity-95 lg:block ">

                    </span>

                    <span className="absolute right-4 bottom-1/2 w-24 h-24 rounded-3xl
                    ...
                    <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
                        <div className="flex sm:flex-row flex-col gap-5 w-full">
                            <form action="#" className="py-1 pl-6 w-full flex gap-3 items-center
                                                        text-heading-3 shadow-2xl shadow-box-shadow
                                                        border-box-border bg-box-bg rounded-full ease-linear focus-within:bg-body
                                ...
                                <input type="email"
                                       ...
                                       className="w-full py-3 rounded-full outline-none bg-transparent"/>
                ...
                <div className="flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl">
                    <img
                        ...
                        width={2350}
                        height={2359}
                        className="lg:absolute lgw-full lg:h-full rounded-3xl object-cover lg:max-h-none max-h-96"/>
                </div>
            </Container>
            <Numbers></Numbers>
        </section>
